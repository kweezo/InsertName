...
namespace renderer {
    ...
    std::vector<i_DescriptorSetLocation> i_DescriptorManager::AllocateDescriptorSetBatch(
        ...
        if (vkAllocateDescriptorSets(i_Device::GetDevice(), &descriptorSetAllocInfo,
                                     descriptorSets[descriptorPools.front()].data()) != VK_SUCCESS) {
