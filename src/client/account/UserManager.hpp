...
public:
    ...
    int loginUser(const char loginType,const std::string &username, const std::string &password);
    ...
    std::string stickMessage(const char dataType, const std::string &str1, int num);
    std::string stickMessage(const char dataType, const std::string &str1);
